  ...
  return (
    <main className="admin-studio">
      ...
      <section className="admin-grid">
        ...
        <Link href="/admin/seo" className="admin-module"><span>SEARCH</span><h2>SEO / GEO / AEO</h2><p>Run the SEO Monitoring Engine, inspect evidence and use the governed SEO Intelligence Agent. IndexNow remains available as a dedicated action.</p><strong>Open SEO Intelligence →</strong></Link>
