...
@media(prefers-reduced-motion:reduce){.phone-slide{transition:none}.mobile-hero-video,.phone-slide video{display:none}.donya-hero{background:url('/2nya-media/donya-bg-v2.webp') center/cover no-repeat!important}.phone-slide[data-phone-slide="0"]{background:#160b10 url('/assets/hero-poster.webp') center/cover no-repeat}}
</style>`;
