    ...
    <main className="shell">
      ...
      <section className="contentGrid">
        <div className="moduleArea">
          <div className="sectionHeading"><div><p className="label">Core modules</p><h2>Operational foundation</h2></div><span className="pill">External writes locked</span></div>
          <div className="grid">{modules.map((module) => <article className="card" key={module.code}><span>{module.code}</span><h3>{module.name}</h3><p>{module.status}</p></article>)}</div>
        </div>
